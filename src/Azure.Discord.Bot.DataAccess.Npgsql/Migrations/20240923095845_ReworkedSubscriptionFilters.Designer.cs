...
namespace Azure.Discord.Bot.DataAccess.Npgsql.Migrations
{
    ...
    [Migration("20240923095845_ReworkedSubscriptionFilters")]
    partial class ReworkedSubscriptionFilters
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Azure.Discord.Bot.Models.SubscriptionMetadata", "Filters", b1 =>
                        {
                            ...
                            b1.Property<string>("subscription_id")
                                .IsRequired()
                                .HasColumnType("text");
                            ...
                            b1.ToTable("subscription_metadata");
